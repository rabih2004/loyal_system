...
// Question labels for maintenance / delivery
...
<div class="wrap ls-admin-wrap">
    ...
    <ul class="subsubsub" style="margin-bottom:12px;">
        <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=ls-feedback' ) ); ?>"
            ...
            <?php esc_html_e( 'All', 'loyal-system' ); ?>
        ...
        <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=ls-feedback&feedback_type=delivery' ) ); ?>"
            ...
            &#128666; <?php esc_html_e( 'Delivery', 'loyal-system' ); ?>
        ...
        <li><a href="<?php echo esc_url( admin_url( 'admin.php?page=ls-feedback&feedback_type=merchant' ) ); ?>"
            ...
            &#127978; <?php esc_html_e( 'Merchant', 'loyal-system' ); ?>
    ...
    <?php if ( $is_all ) : ?><h2 style="margin-top:16px;font-size:14px;font-weight:700;">&#127978; <?php esc_html_e( 'Merchant', 'loyal-system' ); ?></h2><?php endif; ?>
    <table class="wp-list-table widefat fixed striped">
        ...
        <?php if ( empty( $rows_merchant ) ) : ?>
            <tr><td colspan="11"><?php esc_html_e( 'No merchant feedback yet.', 'loyal-system' ); ?></td></tr>
        <?php else : ?>
    ...
    <?php if ( $is_all ) : ?><h2 style="margin-top:20px;font-size:14px;font-weight:700;">&#128295;&#128666; <?php esc_html_e( 'Maintenance &amp; Delivery', 'loyal-system' ); ?></h2><?php endif; ?>
    <table class="wp-list-table widefat fixed striped">
        <thead>
            <tr>
                <th style="width:40px;">#</th>
        ...
        <?php if ( empty( $rows_feedback ) ) : ?>
            <tr><td colspan="6"><?php esc_html_e( 'No feedback yet.', 'loyal-system' ); ?></td></tr>
        <?php else : ?>
